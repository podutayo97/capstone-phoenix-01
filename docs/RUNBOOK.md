...
Point `taskapp-olaseni.duckdns.org` to the public IP you want to use:
...
```bash
curl -vI https://taskapp-olaseni.duckdns.org
curl -s https://taskapp-olaseni.duckdns.org/api/health
```
...
curl -I https://taskapp-olaseni.duckdns.org
```
